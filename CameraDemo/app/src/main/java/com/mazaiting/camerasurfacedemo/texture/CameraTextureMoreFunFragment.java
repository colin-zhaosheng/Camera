 ...
 * 多功能相机
 */
public class CameraTextureMoreFunFragment extends Fragment {
  /**
   * 相机权限请求标识
   */
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    View root = inflater.inflate(R.layout.fragment_camera_texture_more_fun, container, false);
    initView(root);
    initListener();
    return root;
  }
  ...
  private void initView(View view) {
    ...
    mBtnDelay = view.findViewById(R.id.btn_delay);
  ...
  private void delayTake() {
    ...
    Toast.makeText(getActivity(), ""+mDelayTime, Toast.LENGTH_SHORT).show();
